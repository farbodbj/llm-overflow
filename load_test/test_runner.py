...
class LoadTester:
    ...
    async def run_test(self):
        ...
        for num_users in range(1, self.max_users + 1, self.step):
            ...
            avg_time_to_first_token = sum(result.time_to_first_token for result in results) / float(len(results))
            ...
            self.report_results(num_users, successful_requests, total_tokens, total_time, avg_tokens_per_second, avg_time_to_first_token)

    def report_results(self, num_users, successful_requests, total_tokens, total_time, avg_tokens_per_second, avg_time_to_first_token):
        ...
        print(f"  Avg Tokens Time to First Token: {avg_time_to_first_token:.2f}")
